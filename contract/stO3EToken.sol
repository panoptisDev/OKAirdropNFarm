...
contract stO3EcosystemToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "stO3 Ecosystem Token";
    string private constant _symbol = "stO3E";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xFd04cC12e8F5B50cF228c3ECd1B5064fe2e2de79);//
